import { ArrowRight, BookOpen, CheckCircle2, Layers3, ListChecks, PenLine, Shuffle } from 'lucide-react';
import { Link } from 'react-router-dom';
import type { TrackDefinition } from '../domain/types';
const icons = { shuffle: Shuffle, layers: Layers3, check: CheckCircle2, list: ListChecks, pen: PenLine, book: BookOpen };
